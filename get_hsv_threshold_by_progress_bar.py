...
'''
通过拉动进度条设置不同的HSV阈值，进行颜色提取，可直观有效地确定特定颜色的HSV筛选阈值
'''
...
img_original=cv2.imread('t3.png')
...
while(1):
    ...
    cv2.imshow('img',img_specifiedColor)
    
    if cv2.waitKey(1)==ord('q'):
        break
        
print('lowerbH,lowerbS,lowerbV = ',lowerbH,lowerbS,lowerbV)
print('upperbH,upperbS,upperbV = ',upperbH,upperbS,upperbV)
